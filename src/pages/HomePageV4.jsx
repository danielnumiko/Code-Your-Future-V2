...
import PipelineStrategyV5 from '../components/PipelineStrategyV5'
import PartnerLogos from '../components/PartnerLogos'
import TestimonialCarouselV5 from '../components/TestimonialCarouselV5'
import TraineeSectionV5 from '../components/TraineeSectionV5'
import BlogPreviewV5 from '../components/BlogPreviewV5'
import NewsletterV5 from '../components/NewsletterV5'
...
export default function HomePageV4({ onSwitchConcept, activeConcept }) {
  ...
  return (
    <>
      <motion.div ref={wrapperRef} className="relative" style={{ zIndex: 2, backgroundColor: pageBg, color: pageText }}>
        ...
        <main>
          <HeroV5 onSwitchConcept={onSwitchConcept} />
